...
public class SequenceComparer {
    ...
    public static void main(String[] args) {
        SequenceComparer sc = new SequenceComparer(new DNASequence("ATACGATACGATACGATACGATACG"), new DNASequence("ATACGATACGATACGATACGAACG", AmbiguityDNACompoundSet.getDNACompoundSet()));
